...
function renderTransition(Component2, runTransition, props) {
  if (Component2) {
    return (0, import_jsx_runtime82.jsx)(Component2, Object.assign({}, props));
  }
  if (runTransition) {
...
function createButton(name, defaultValue, label = name) {
  const Button3 = React121.forwardRef(({
    children,
    ...props
...
var Spinner = React127.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React128.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React130.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime133.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime133.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime133.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var TabContent = React133.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React134.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React137.forwardRef((props, ref) => (0, import_jsx_runtime141.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React138.createContext({
  // eslint-disable-next-line @typescript-eslint/no-empty-function
  onClose() {
  }
});
...
var ToastHeader = React139.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  return (0, import_jsx_runtime143.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames95.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime142.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React140.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
  ...
  return (0, import_jsx_runtime144.jsx)(Component2, {
    ref,
...
var Toast = React141.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime145.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime145.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition2 ? (0, import_jsx_runtime145.jsx)(Transition2, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React142.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop7 = () => void 0;
var ToggleButton = React143.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime149.jsxs)(import_jsx_runtime148.Fragment, {
    children: [(0, import_jsx_runtime147.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime147.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React144.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime150.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
